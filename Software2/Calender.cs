...
namespace Software2
{
    public partial class Calender : Form
    {
        ...
        public void DisplayLAMBDA()
        {
            ...
            cmd.CommandText = $"SELECT appointmentId AS 'Appointment ID', userId AS 'User ID', customerId AS 'Customer ID', description AS 'Description', type AS 'Type', start AS 'Start Time', end AS 'End Time' FROM appointment {tag};";
